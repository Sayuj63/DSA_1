...
int main() {
    ...
    do {
        ...
        cout << "\n3. Add node at end";
        cout << "\n4. Add node before a node";
        cout << "\n5. Add node after a node";
        cout << "\n6. Delete a node";
        cout << "\n7. Search list";
        cout << "\n8. Count nodes in list";
        cout << "\n9. Exit";
        cout << "\n\nEnter your choice: ";
        cin >> option;
        ...
        switch (option) {
            ...
            case 4:
                cout << "\nEnter the value to be inserted: ";
                cin >> num;
                cout << "\nEnter the position before which the value is to be inserted: ";
                cin >> pos;
                insert_before(num, pos);
                break;
            case 5:
                cout << "\nEnter the value to be inserted: ";
                cin >> num;
...
void insert_before(int value, int beforeValue) {
    if (start == nullptr) {
        cout << "\nList is empty!";
        return;
    }
